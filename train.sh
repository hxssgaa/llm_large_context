python3 -m llamabpt.train \
    ...
    --update_llama_config="dict(max_sequence_length=131072,scan_attention=True,scan_query_chunk_size=2048,scan_key_chunk_size=4096,remat_attention='nothing_saveable',scan_mlp=True,scan_mlp_chunk_size=2048,remat_mlp='nothing_saveable',remat_block='nothing_saveable',scan_layers=True,attention_type='ring_blockwise',param_scan_axis=0,mesh_dim='1,1,4,8')" \
    --load_dataset_state='' \
    --load_checkpoint='' \
    ...
    --train_dataset.huggingface_dataset.seq_length=131072 \
